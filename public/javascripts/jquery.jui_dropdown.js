                ...
                if(encode_version($.ui.version) < encode_version('1.9.0')) {
                    ...
                    elem_menu.off('click', "li").on('click', "li", function() {
                        elem.triggerHandler('onSelect', {
                            index: parseInt($(this).index("#" + menu_id + " li")) + 1, 
                            id: parseInt($(this).attr("data-id")),
                            type: parseInt($(this).attr("data-type")),
                            trip: parseInt($(this).attr("data-id-trip"))
                        })
                    });
                } else {
                    elem_menu.menu({
                        select: function(event, ui) {
                            elem.triggerHandler('onSelect', {
                                index: parseInt(ui.item.index("#" + menu_id + " li")) + 1, 
                                id: parseInt(ui.item.attr("data-id")),
                                type: parseInt(ui.item.attr("data-type")),
                                trip: parseInt(ui.item.attr("data-id-trip"))
                            })
                        }
                    }).menu('refresh').hide();
                }
