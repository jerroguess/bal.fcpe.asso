...
/*
  --------------------------------------------------------------------
  view.bo.suggestionafficher.php
  --------------------------------------------------------------------
 ...
 */
	...
	add_cadre_open_form('suggestion', 'soumettre', 'formulairePrincipale');
	...
	echo '<h1><img class="fcpe" alt="logo" src="public/images/fcpe.png">&nbsp;&nbsp;' . _("vbo_suggestionafficher_titre") . '</h1>';
	echo '<br/>';
	echo '<br/>';
	echo _("vbo_suggestionafficher_description");
	echo '<br/>';
	echo '<br/>';
	...
	echo '<button class="btn btn-primary" type="submit">' . _("vbo_suggestionafficher_envoyer") . '</button>';
